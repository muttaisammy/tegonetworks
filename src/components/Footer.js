          ...
          <div className="side1">
            <div className="row">
              <div className="col-md-3">
                <h1 className="logo">Tego Networks</h1>
                <p className="footer-text">
                  Inter Networking & Internet Service Provisioning
          ...
          <div className="side2">
            <div className="row">
              ...
              <div className="col-md-3">
                ...
                <ul>
                  <li>
                    <a target="_blank" rel="noreferrer" href="https://github.com/tegonetwroks" > Github</a>
                  </li>
                  <li>
